    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-gray-300 mb-6">Stay updated with our latest offers, deals and travel tips</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="text-xl font-bold mb-4">TravelEase</h4>
            <p className="text-gray-400 mb-4">
              Making travel planning easy and enjoyable with handpicked destinations and personalized experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">COVID-19 Resources</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 mt-8 text-center text-sm text-gray-400">
